  ...
  return (
    <div className="App">
      <div className="time-div">
        <p>{getDay()}</p>
        <p>
          {time_array[0].slice(-2)}:{time_array[1]}
        </p>
        <p>{am_pm}</p>
      </div>
      <div className="link-div">
        ...
        <a href="https://en.wikipedia.org/wiki/Special:Random">
          <img alt="wikipedia" src={require("./images/wikipedia.png")} />
        </a>
        <a href="https://www.rust-lang.org/learn">
          <img alt="rustbook" src={require("./images/rust.png")} />
        </a>
        <a href="https://www.typescriptlang.org/docs/">
          <img alt="typescript" src={require("./images/typescript.png")} />
        </a>
        <a href="https://cycling74.com/forums">
          <img alt="cycling74 forum" src={require("./images/cycling74.png")} />
        </a>
      </div>
    </div>
  );
